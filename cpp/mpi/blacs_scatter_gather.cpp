...
int main() {
    ...
    MPI_Bcast(&nrow_blk, 1, MPI_INT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&ncol_blk, 1, MPI_INT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&ip_src_row, 1, MPI_INT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&ip_src_col, 1, MPI_INT, 0, MPI_COMM_WORLD);
